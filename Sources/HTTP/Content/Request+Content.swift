...
extension Request {
    public init<T : MapRepresentable>(method: Method = .get, url: URL, headers: Headers = [:], content: T) {
        self.init(
            method: method,
            url: url,
            headers: headers,
    ...
    public init<T: MapRepresentable>(method: Method = .get, url: URL, headers: Headers = [:], content: [String: T]) {
        self.init(
            method: method,
            url: url,
            headers: headers,
...
//    public init<T : MapFallibleRepresentable>(method: Method = .get, url: URL, headers: Headers = [:], content: T) throws {
//        self.init(
//            method: method,
//            url: url,
//            headers: headers,
